...
class VotingModule(nn.Module):
    ...
    # def forward(self, seed_xyz, seed_features,prob_logits):
    def forward(self, seed_xyz, seed_features):
        ...
        # prob1=prob.unsqueeze(2).unsqueeze(2)

        residual_features = net[:,:,:,3:] # (batch_size, num_seed, vote_factor, out_dim)
        vote_features = seed_features.transpose(2,1).unsqueeze(2) + residual_features

        # prob1=prob1.expand_as(vote_features)
        # vote_features=vote_features * prob1
