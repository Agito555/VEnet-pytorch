...
class SunrgbdDetectionVotesDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        instance_labels=np.load(os.path.join(self.data_path, scan_name)+'_instance_label.npy') # N x 1
        instance_labels=np.squeeze(instance_labels,1)
        ...
        ret_dict['instance_label'] = instance_labels
